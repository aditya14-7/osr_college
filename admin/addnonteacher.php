		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					<a href="#" class="breadcrumb-item"><i class="icon-copy"></i> Manage Non-Teaching </a>
					<span class="breadcrumb-item active">Add Non-Teaching Staff</span>
				</div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Add Non - Teaching Staff</h5>
                ...
                <div class="card-body">
                    <form action="nontech.php" method="post" enctype="multipart/form-data" id="form1">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Staff Name<span class="clcl"> *</span></label>
                                    <input type="text" class="form-control" name="name" placeholder="Staff Name" autocomplete="off" required />
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="text-left">
                            <button type="submit" id="btn" class="btn btn-primary">Add Staff</button>
                        </div>
                    </form>
                </div>
            </div>
