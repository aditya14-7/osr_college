		...
		<!-- Traffic sources -->
			<div class="card">
				<div class="card-header header-elements-inline">
					<h5 class="card-title">Add SSR</h5>
				...
				<input type="submit" name="time-table" value="Upload">-->
					<div class="card-body">
						...
						<div class="text-left col-sm-4 container">
							<input type="submit" name="ssr_upload" value="Upload" class="btn btn-primary btn-block">
						</div>
					</form>
					<hr/>
					<table class="table datatable-button-init-basic datatable-reorder">
						...
						<tbody>
							...
							<tr>
								<td><?php echo $a;$a++;?></td>
								<td><a href="<?php  echo $row['ssr_file'];?>" target="_blank">Click Here</a></td>
								<td><?php echo $row['added_on'];?></td>
								<td><?php echo $row['session']; ?></td>
								<td><a href="del_ssr.php?id=<?php echo $row['ssr_id'];?>">Delete</a></td>
							</tr>
							<?php
								}
							?>
