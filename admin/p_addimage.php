		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					<a href="#" class="breadcrumb-item"><i class="icon-stack"></i>   Manage Press Release</a>
					<span class="breadcrumb-item active">Add Press Release</span>
				</div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Add Press Release Images</h5>
                ...
                <div class="card-body">
                    <form action="p_image.php" method="post" enctype="multipart/form-data">
