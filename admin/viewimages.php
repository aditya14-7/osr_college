...
?>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					<a href="#" class="breadcrumb-item"><i class="icon-copy"></i> Manage Gallery</a>
					<span class="breadcrumb-item active">View Gallery</span>
				</div>
    ...
    <table class="table datatable-button-init-basic datatable-reorder">
	    ...
	    ?>
            <tr>
                <td><?php echo $a; $a++; ?></td>
                <td><img height="100" width="100" src="gallery/<?php echo $row['pic'];?>" /></td>
                <td><?php echo $row['text1'];?></td>
                <td><?php echo $row['text2'];?></td>
                <td><?php echo $row['date'];?></td>
                <td><a href="gdel.php?id=<?php echo $row['0'];?>">Delete</a></td>
            </tr>
        <?php
		  }
		?>
