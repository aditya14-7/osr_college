                    ...
                    <div class="col-lg-12 col-xl-8">
                        <div class="inner mt_mobile--40">
                            <div class="section-title text-start" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <span class="pre-title">Arts Department</span>
                                <h3 class="title">Arts Department</h3>
                            </div>
                                     ...
                                     <table class="my-tbl">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Intermediate</td>
                                                <td>Hindi, English</td>
                                                <td>Data will be uploaded soon...</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>UG, B.A.</td>
                                                <td>Department of Home Science</td>
                                                <td>Three Year</td>
                                                <td>Intermediate</td>
                                                <td>Hindi, English</td>
                                                <td>Data will be uploaded soon...</td>
