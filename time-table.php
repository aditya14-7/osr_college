...
$q_nont = "select * from time_table order by t_id desc";
$res_nont = mysqli_query($dbCon, $q_nont);
      ...
      <!--  menu end -->
        ...
        <div class="edu-contact-us-area eduvibe-contact-us edu-section-gap bg-color-white">
               <div class="container eduvibe-animated-shape">
                   ...
                   <div class="row g-5">
                       <div class="col-lg-12">
                           <div class="section-title text-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                               <span class="pre-title">Time Table</span>
                   ...
                   <?php
                   $i=1;
                   while($row_tt = mysqli_fetch_array($res_nont)){
                   ?>
                    <!-- Start Event List  -->
                            ...
                            <div class="inner">
                                ...
                                <div class="content">
                                    <div class="content-left">
                                        <h5 class="title"><a href="admin/<?php echo $row_tt['time_table_file']; ?>" target="_blank"><?php echo $i .". ". $row_tt['session']; ?> (Click here to view)</a></h5>
                                    </div>
                                </div>
